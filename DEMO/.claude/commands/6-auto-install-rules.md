...
1. **Gather Information** - Ask the user for:
   ...
   - Project prefix (3-letter customer code, e.g., CON, FAB, CON)
...
2. **Validate Inputs**:
   ...
   - Validate prefix is exactly 3 uppercase letters (e.g., CON, CON, FAB)
...
- Replace CON prefix with user's prefix throughout all files
