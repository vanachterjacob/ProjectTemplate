...
1. **Prefix Usage**
   - ALWAYS use the CON prefix (replace with actual 3-letter customer code)
   - Check `.cursor/rules/000-project-overview.mdc` for the current project prefix
   - Example: `table 77100 "CON Customer Credit"`
...
```al
codeunit 77110 "CON Sales Subscribers"
{
