...
Write-Host "   • BC27\ - Base code comprehensive index (9 documentation files)"
...
Write-Host "   • BC27\ - Business Central 27 base code comprehensive index (9 files)"
Write-Host "      Start with: BC27\BC27_INDEX_README.md"
Write-Host "      For extensions: BC27_EVENT_CATALOG.md → BC27_EXTENSION_POINTS.md"
