...
Write-Host "   • BC27\ - Base code comprehensive index (14 files: 10 core + 4 module-specific)"
...
Write-Host "   • BC27\ - Business Central 27 base code comprehensive index (14 files)"
Write-Host "      Start with: BC27\BC27_INDEX_README.md"
Write-Host "      Event search: BC27_EVENT_INDEX.md (175+ events)"
