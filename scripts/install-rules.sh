...
echo "   • BC27/ - Base code comprehensive index (14 files: 10 core + 4 module-specific)"
...
echo ""
echo "📖 Documentation:"
echo "   • BC27/ - Business Central 27 base code comprehensive index (14 files)"
echo "      Start with: BC27/BC27_INDEX_README.md"
echo "      Event search: BC27_EVENT_INDEX.md (175+ events)"
